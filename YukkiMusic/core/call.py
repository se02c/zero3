    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**◍ عفوا الكول مغلق في جروبك**\n\nمن فضل قم بتشغيل المحادثه الصوتيه اولا في مجموعتك. واذا كانت بلفعل مشغله قم بإنهاء المحدثه وابدأ تشغليها من جديد واذا تكررت المشكله قم بتحديث الروبوت , اكتب /restart √"
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**◍ المساعد موجود بلفعل**\n\nاكتشف النظام ان المسلعد بلفعل في المحادثه الصوتيه بلفعل, هذه المشكله تاتي عندما يتم تشغيل البوت مرتين.\n\nاذا لم يكن المساعد يعمل في المحادثه قم باانهاء المحاثه وتشغيلها من جدي واذا استمرت المشكله قم بتحديث البوت, اكتب /restart √"
            )
